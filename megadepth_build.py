...
from cotracker.datasets import megadepth_load
...
class MultiviewMatcherDataModule(LightningDataModule):
    def __init__(self, *args, **kwargs):
        ...
        self.train_list_path = kwargs['train_val_list_path'] + "/train_list.txt" # txt file contains training scene
        self.val_list_path = kwargs['train_val_list_path'] + "/val_list.txt"
